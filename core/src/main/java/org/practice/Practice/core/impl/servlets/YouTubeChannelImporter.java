package org.practice.Practice.core.impl.servlets;
...
import org.practice.Practice.core.models.VedioProperties;
...
public class YouTubeChannelImporter implements Importer {
    ...
    @Override
    public void importData(String s, String s2, Resource resource, String s3, String s4) throws ImportException {
     ...
     * @throws org.apache.sling.commons.json.JSONException the JSON exception
     */
    ...
    private void WriteNode(VedioProperties video, final Resource resource)
        ...
        if (!parent.hasNode(video.getVideoId())) {
            ...
            InputStream stream = new FileInputStream("/media/intelligrape/disk2/youtube/images/"
    ...
    public static void fileUrl(String fAddress, String localFileName) {
        ...
        try {
            ...
            outStream = new BufferedOutputStream(new FileOutputStream(
                    "/media/intelligrape/disk2/youtube/images/" + localFileName + ".jpeg"));
